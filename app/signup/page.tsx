  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-full h-screen gap-10 text-gray-900 dark:text-white max-sm:px-8">
      ...
      <div className="flex items-center justify-center gap-6">
        ...
        <h1 className="text-4xl font-bold max-sm:text-2xl max-sm:text-center text-gray-900 dark:text-white">
          Welcome to Sign Up{" "}
        ...
        >
          ...
          <div className="flex justify-between max-sm:w-full w-[50vw]">
            <div className="flex items-center justify-center gap-3">
              ...
              />
              <label className="text-base font-medium text-gray-900 dark:text-white" htmlFor="remember-me-signup">
                Remember Me
              </label>
            </div>
            <div>
